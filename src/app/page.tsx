...
export default function Home() {
  ...
  <section id="our-verticals" className="home-surface-feature scroll-mt-24 border-b border-slate-200 py-16 md:py-24">
            ...
            <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-[1fr_1px_1fr] md:gap-0">
              ...
              <div data-reveal className="md:pr-10 lg:pr-14">
                ...
                <h2 className="mt-1 font-[family-name:var(--font-playfair),serif] text-3xl font-bold leading-[1.15] tracking-tight text-slate-900 md:text-[2.5rem]">
                  The Hayat <span className="text-[var(--brand-gold)]">Way</span>
                </h2>
      ...
      <section className="home-surface-cool border-b border-slate-200 py-14 md:py-16">
        <div className={homeShell}>
          <div className={homeInner}>
            <div className="rounded-3xl bg-[var(--brand-navy)] px-6 py-10 md:px-10 md:py-12">
              <div className="grid items-start gap-8 lg:grid-cols-[1fr_auto]">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--brand-coral)]">
                    Events & Ceremonies
                  </p>
                  <h2 className="mt-3 text-3xl font-bold text-white md:text-4xl">
                    Need Space For An Event, Ceremony, Or Gathering?
                  </h2>
                  <p className="mt-4 max-w-3xl text-base leading-7 text-white/85">
                    We provide hall space at our office for events, ceremonies,
                    and other community functions. The hall is available
                    <strong className="text-white"> after 5:00 PM on weekdays</strong>
                    {" "}and <strong className="text-white">full day on weekends</strong>.
                  </p>
                  <div className="mt-7 flex flex-wrap gap-3">
                    <Link
                      href="/venue-rental"
                      className="inline-flex items-center justify-center rounded-full bg-[var(--brand-coral)] px-7 py-3 text-sm font-bold text-white transition hover:bg-[var(--brand-coral-hover)]"
                    >
                      View Event Space
                    </Link>
                    <Link
                      href="/contact"
                      className="inline-flex items-center justify-center rounded-full border-2 border-white px-7 py-3 text-sm font-bold text-white transition hover:bg-white hover:text-[var(--brand-navy)]"
                    >
                      Contact For Booking
                    </Link>
                  </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                  <div className="rounded-2xl bg-white/10 px-5 py-4 text-center">
                    <p className="text-2xl font-extrabold text-white">After 5 PM</p>
                    <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-white/75">
                      Weekdays
                    </p>
                  </div>
                  <div className="rounded-2xl bg-white/10 px-5 py-4 text-center">
                    <p className="text-2xl font-extrabold text-white">Full Day</p>
                    <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-white/75">
                      Weekends
                    </p>
                  </div>
